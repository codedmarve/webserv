...
//             std::string key = trimmer(line.substr(0, separatorPos));
//             std::string value = trimmer(line.substr(separatorPos + 1));

//             // Store the header key-value pair
//             headers_[key] = value;
//         } else {
//             // If no separator found, it's an invalid format
//             return 400; // Bad Request: Invalid trailer format
//         }
//     }

//     // If we reach here, it means the end of buffer without an empty line
//     return 400; // Bad Request: Incomplete trailer
// }
...
//             buffer_.erase(0, end + 2); // Remove processed chunk size
...
//                 buffer_.erase(0, chunk_size_ + 2); // Remove processed chunk data
//                 chunk_size_ = 0;
...
//                 buffer_.clear(); // Clear buffer after appending
//             }
//         }
//     }
