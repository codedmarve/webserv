...
IpAddressResolver::IpAddressResolver(const IpAddressResolver &rhs)
    : addressHints(rhs.addressHints), addressResults(NULL)
{
    if (rhs.addressResults != NULL)
    {
...
IpAddressResolver &IpAddressResolver::operator=(const IpAddressResolver &rhs)
{
    if (this != &rhs)
    {
        addressHints = rhs.addressHints;
